...
from xadmin_api.init_views import LoginView, CurrentUserView, CaptchaView, UserSendCaptchaView, DashBoardView, \
    UploadView, MenuView, UserChangePasswordView, UserListChangePasswordView, UserLogoutView
from xadmin_api.init_views import TyAdminSysLogViewSet, TyAdminEmailVerifyRecordViewSet
